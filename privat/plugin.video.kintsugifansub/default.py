# -*- coding: utf-8 -*-
"""Kintsugi Fansub - Kodi videó plugin belépési pont (router)."""
import sys
...
from resources.lib import kintsugifansub as mtk
...
def view_root():
    ...
    add_dir('[COLOR gold]★ Legfrissebb részek (aktív projektek)[/COLOR]',
            build_url(action='latest'))
