...
- **REMUX-keresés és minőség-felismerés** – REMUX szűrő és kategóriák, DV-profil, HDR10+, BD50, TC/TS/CAM jelzés, kiadás-címkék (Extended, Director's Cut, …), minőség szerinti rendezés. **REMUX seed szerint** menüpontok (Film/Sorozat HU/EN) – a legtöbbet seedelt REMUX-ok elöl. **Rendezés-választó ablak** a kategóriák megnyitásakor (feltöltés ideje, seed, letöltések, méret, név).
