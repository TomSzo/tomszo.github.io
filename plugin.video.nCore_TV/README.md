...
- **Ajánlók nCore-elérhetőséggel:** minden ajánlott cím mellett látszik, hány élő verzió van fent nCore-on (és milyen minőségben), kattintásra egyből a színkódolt verzióválasztó jön; a nem elérhetők elrejthetők.
